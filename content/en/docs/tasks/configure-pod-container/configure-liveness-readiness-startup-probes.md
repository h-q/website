...
try `failureThreshold` times before giving up. Giving up in case of liveness probe and startup probe means restarting the container. In case of readiness probe the Pod will be marked Unready.
